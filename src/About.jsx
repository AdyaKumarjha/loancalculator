...
function About(){
    return(
        <div>
            ...
            <p >This Loan Calculator App is a modern, single-page web application built using <strong>React JS</strong> and <strong>Material UI</strong>. It allows users to calculate loan EMIs (Equated Monthly Installments), view a detailed amortization schedule, and see real-time currency conversions of their EMI using live exchange rates.</p>
            <br/>
            ...
            <ul>
                ...
                <li>Implement both <strong>light and dark modes</strong> using Material UI's theming system.</li><li>Add a <strong>404 Not Found</strong> page for unmatched routes.</li>
                ...
                <p>This app integrates with the free tier of the <a  href="https://app.exchangerate-api.com">ExchangeRate-API</a> to fetch live exchange rates.</p>
                <p>API Endpoint Example:<code>https://v6.exchangerate-api.com/v6/YOUR_API_KEY/latest/USD</code></p>
                <p>You must register and obtain a free API key to use this endpoint. Then, replace <code>YOUR_API_KEY</code> in the app code with your actual key.</p>
